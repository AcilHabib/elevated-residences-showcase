...
const base: Record<Locale, Dict> = {
  fr: {
    ...
    "footer.residence_line": "Résidence Azimour · Bni Ksila · Benchallal Immo",
  ...
  en: {
    ...
    "footer.residence_line": "Azimour Residence · Bni Ksila · Benchallal Immo",
  ...
  ar: {
    ...
    "footer.residence_line": "إقامة أزيمور · بني كسيلة · Benchallal Immo",
